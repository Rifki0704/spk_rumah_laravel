    ...
    <div id="app" class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-dark bg-info app-shadow">
            ...
            <a href="{{ url('/') }}" class="brand-link bg-info mx-auto py-0 d-inline-block d-sm-none">
                <img src="{{ asset('images/house.png') }}" alt="APP Logo" class="brand-image p-1 mt-0 ml-0 bg-white img-circle" style="opacity: .8">
                <span class="brand-text font-weight-bold h3">SPK</span>
            </a>
